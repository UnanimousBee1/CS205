...
case class NonEmptyQueue[A] (first: A, rest: Queue[A]) extends Queue[A]{//Class for non empry queue
  override def equals(obj: Any): Boolean = (this,obj) match{//Is equals function
case _ @ (NonEmptyQueue(s, r: Queue[A]), NonEmptyQueue(a, b: Queue[A])) => (s==a && r.equals(b))
case _ => false
  }
  
override def hashCode : Int = first.hashCode + rest.hashCode //Hash code function
}
...
object Q1 {
  def main(args: Array[String]): Unit = {
    ...
    var nq1: Queue[Int] = NonEmptyQueue(1,NonEmptyQueue(2,NonEmptyQueue(3,EmptyQueue())))
    println(nq.equals(nq1));
